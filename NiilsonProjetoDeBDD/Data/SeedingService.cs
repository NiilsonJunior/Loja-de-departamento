...
using NiilsonProjetoDeBDD.Models.Enums;

namespace NiilsonProjetoDeBDD.Data
{
    public class SeedingService
    {
        private NiilsonProjetoDeBDDContext _context;

        public SeedingService(NiilsonProjetoDeBDDContext context)
        {
            _context = context;
        }
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Thales", "thales1@gmail.com", new DateTime(2000, 4, 11), 5000.0, d1);
            Seller s3 = new Seller(3, "Lanna", "lanninhap@gmail.com", new DateTime(2000, 2, 29), 900.0, d1);
            Seller s4 = new Seller(4, "Felipe", "feeh.kcs@gmail.com", new DateTime(2006, 4, 21), 600.33, d1);
            Seller s5 = new Seller(5, "Ana", "ana04@gmail.com", new DateTime(1988, 8, 12), 1200.10, d1);
            Seller s6 = new Seller(6, "Niilson", "niilson.kcs@gmail.com", new DateTime(1948, 1, 21), 10200.10, d1);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2021, 06, 24), 11000.0, SaleStatus.Billed, s1);
